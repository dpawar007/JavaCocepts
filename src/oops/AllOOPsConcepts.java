...
class Mobile extends Product{ // IS-A Relationship, Mobile IS-A Product, Mobile is Child, Product is Parent 
	...
	//We have redefined the same methods from the parent into the child with different inputs
...
public class AllOOPsConcepts {
	...
	public static void main(String[] args) {
		...
		System.out.println("product is : "+product); //we get 7851e922 as a hashCode, so product is a ref var not an object
